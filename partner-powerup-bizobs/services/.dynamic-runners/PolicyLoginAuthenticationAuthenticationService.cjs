// Auto-generated wrapper for PolicyLoginAuthenticationAuthenticationService
process.env.SERVICE_NAME = "PolicyLoginAuthenticationAuthenticationService";
process.env.STEP_NAME = "PolicyLoginAuthentication";
