// Auto-generated wrapper for PostPurchaseProcessingService
process.env.SERVICE_NAME = "PostPurchaseProcessingService";
process.env.STEP_NAME = "PostPurchaseProcessing";
