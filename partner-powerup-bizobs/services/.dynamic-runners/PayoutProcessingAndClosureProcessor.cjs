// Auto-generated wrapper for PayoutProcessingAndClosureProcessor
process.env.SERVICE_NAME = "PayoutProcessingAndClosureProcessor";
process.env.STEP_NAME = "PayoutProcessingAndClosure";
