// Auto-generated wrapper for FinalAssemblyAndInspectionService
process.env.SERVICE_NAME = "FinalAssemblyAndInspectionService";
process.env.STEP_NAME = "FinalAssemblyAndInspection";
