// Auto-generated wrapper for PostPurchaseFulfillmentService
process.env.SERVICE_NAME = "PostPurchaseFulfillmentService";
process.env.STEP_NAME = "PostPurchaseFulfillment";
