// Auto-generated wrapper for PowertrainInstallationService
process.env.SERVICE_NAME = "PowertrainInstallationService";
process.env.STEP_NAME = "PowertrainInstallation";
