// Auto-generated wrapper for ClaimInitiationAndUploadInitiationService
process.env.SERVICE_NAME = "ClaimInitiationAndUploadInitiationService";
process.env.STEP_NAME = "ClaimInitiationAndUpload";
