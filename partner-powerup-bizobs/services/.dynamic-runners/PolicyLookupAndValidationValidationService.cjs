// Auto-generated wrapper for PolicyLookupAndValidationValidationService
process.env.SERVICE_NAME = "PolicyLookupAndValidationValidationService";
process.env.STEP_NAME = "PolicyLookupAndValidation";
