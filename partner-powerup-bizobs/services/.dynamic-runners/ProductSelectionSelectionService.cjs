// Auto-generated wrapper for ProductSelectionSelectionService
process.env.SERVICE_NAME = "ProductSelectionSelectionService";
process.env.STEP_NAME = "ProductSelection";
