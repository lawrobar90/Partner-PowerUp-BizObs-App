// Auto-generated wrapper for ClaimAssessmentAndRoutingProcessingService
process.env.SERVICE_NAME = "ClaimAssessmentAndRoutingProcessingService";
process.env.STEP_NAME = "ClaimAssessmentAndRouting";
