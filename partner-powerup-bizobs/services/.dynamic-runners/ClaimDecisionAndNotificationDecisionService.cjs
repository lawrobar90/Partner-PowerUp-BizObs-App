// Auto-generated wrapper for ClaimDecisionAndNotificationDecisionService
process.env.SERVICE_NAME = "ClaimDecisionAndNotificationDecisionService";
process.env.STEP_NAME = "ClaimDecisionAndNotification";
